// public/simple-mediasoup-client.js
class SimpleMediasoupClient {
    constructor(options) {
      ...
      this._log('SimpleMediasoupClient initialized');
    }
    ...
    _log(...args) {
      if (this.debug) {
        console.log('[SimpleMediasoupClient]', ...args);
      }
    }
    
    _error(...args) {
      console.error('[SimpleMediasoupClient]', ...args);
    }
  }